    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Eduardo Alves Lins</h1>
      ...
      {/* About Section */}
      <section className="py-16 px-6 md:px-12 bg-accent">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <Link to="/about" className="text-white flex items-center gap-2 hover:text-primary transition-colors">
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-end">
            <Link to="/projects" className="text-white flex items-center gap-2 hover:text-primary transition-colors">
